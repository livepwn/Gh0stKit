...
def print_interface():
    print_banner()
    print(Back.BLACK + Fore.GREEN + Style.BRIGHT + "  + -- [ hahasecure v1 ]" + Fore.YELLOW + Style.BRIGHT + "  - BETA" + Style.RESET_ALL)
    ...
    print(Back.BLACK + Fore.RED + Style.BRIGHT + "         |  https://github.com/livepwn/hahasecure" + Style.RESET_ALL)
...
class ShellcodeModule:
    ...
    def run(self):
        ...
        while True:
            print(Back.BLACK + Fore.CYAN + Style.BRIGHT + "\nhahasecure/shellcode > " + Style.RESET_ALL, end="")
            cmd = input("").strip().split()
            if not cmd:
                continue
            if cmd[0] == "help":
...
class BackdoorModule:
    ...
    def run(self):
        ...
        print("Type 'help' for available commands.")
        while True:
            print(Back.BLACK + Fore.CYAN + Style.BRIGHT + "\nhahasecure/backdoor> " + Style.RESET_ALL, end="")
            cmd = input("").strip().split()
            if not cmd:
                continue
            if cmd[0] == "help":
...
class InjectorModule:
    def run(self):
        ...
        print("Type 'help' for available commands.")
        while True:
            print(Back.BLACK + Fore.CYAN + Style.BRIGHT + "\nhahasecure/injector> " + Style.RESET_ALL, end="")
            cmd = input("").strip().split()
            if not cmd:
                continue
            if cmd[0] == "help":
...
class EncoderModule:
    ...
    def run(self):
        ...
        while True:  # Main loop for the encoder module
            print(Back.BLACK + Fore.CYAN + Style.BRIGHT + "\nhahasecure/encoder> " + Style.RESET_ALL, end="")
            cmd = input("").strip().split()
            if not cmd:
...
class ExecutableModule:
    ...
    def run(self):
        ...
        while True:
            print(Back.BLACK + Fore.CYAN + Style.BRIGHT + "\nhahasecure/executable> " + Style.RESET_ALL, end="")
            cmd = input("").strip().split()
            if not cmd:
                continue
            if cmd[0] == "help":
